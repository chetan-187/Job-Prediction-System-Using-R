...
# ds_Data[grepl("Junior",ds_Data$Job_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# ds_Data[grepl("Intern",ds_Data$Job_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# ds_Data[grepl("Senior",ds_Data$Job_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# ds_Data[grepl("Sr",ds_Data$Job_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
#ds_Data[grepl("Jr",ds_Data$Job_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# soft_Data[grepl("Junior",soft_Data$soft_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# soft_Data[grepl("Intern",soft_Data$soft_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# soft_Data[grepl("Senior",soft_Data$soft_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# soft_Data[grepl("Sr",soft_Data$soft_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# soft_Data[grepl("Jr",soft_Data$soft_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# android_Data[grepl("Junior",android_Data$android_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# android_Data[grepl("Intern",android_Data$android_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# android_Data[grepl("Senior",android_Data$android_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# android_Data[grepl("Sr",android_Data$android_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# android_Data[grepl("Jr",android_Data$android_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# it_Data[grepl("Junior",it_Data$it_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# it_Data[grepl("Intern",it_Data$it_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# it_Data[grepl("Senior",it_Data$it_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# it_Data[grepl("Sr",it_Data$it_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# it_Data[grepl("Jr",it_Data$it_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# entc_Data[grepl("Junior",entc_Data$entc_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# entc_Data[grepl("Intern",entc_Data$entc_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# entc_Data[grepl("Senior",entc_Data$entc_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# entc_Data[grepl("Sr",entc_Data$entc_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# entc_Data[grepl("Jr",entc_Data$entc_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# ai_ml_Data[grepl("Junior",ai_ml_Data$ai_ml_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# ai_ml_Data[grepl("Intern",ai_ml_Data$ai_ml_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# ai_ml_Data[grepl("Senior",ai_ml_Data$ai_ml_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# ai_ml_Data[grepl("Sr",ai_ml_Data$ai_ml_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# ai_ml_Data[grepl("Jr",ai_ml_Data$ai_ml_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# dbms_Data[grepl("Junior",dbms_Data$dbms_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# dbms_Data[grepl("Intern",dbms_Data$dbms_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# dbms_Data[grepl("Senior",dbms_Data$dbms_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# dbms_Data[grepl("Sr",dbms_Data$dbms_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# dbms_Data[grepl("Jr",dbms_Data$dbms_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
...
# tech_analyst_Data[grepl("Junior",tech_analyst_Data$tech_analyst_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# tech_analyst_Data[grepl("Intern",tech_analyst_Data$tech_analyst_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
# tech_analyst_Data[grepl("Senior",tech_analyst_Data$tech_analyst_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# tech_analyst_Data[grepl("Sr",tech_analyst_Data$tech_analyst_post),]$Experience_in_years = floor(runif(1,min = 5, max = 10))
# tech_analyst_Data[grepl("Jr",tech_analyst_Data$tech_analyst_post),]$Experience_in_years = floor(runif(1,min = 0, max = 2))
